...
Die Xamarin entwickler versprechen, dass alles was in Swift, Objective-C,
...
Moderne Webanwendungen bestechen heutzutage meist nicht nur mit ihrem komplexen Design, Komplexität lässt sich auch meist nicht in der Entwicklung
...
Der W3C beschreibt diverse Wege wie entkoppelte wiederverwendbare UI Elemente, so genannte Web Components,
...
Hier kommen Polyfills ins spiel. Polyfills implementieren fehlende Browserfeatures und gewährleisten nahezu Vollständigen
Support von unter anderem Web Components. Ein weiteres Beispiel für ein Polyfill ist core-js,
welches die die Nutzung von ES5 und ES6, auch wenn der Browser diesen Standard nicht unterstützt, ermöglicht.
...
2009 erschien ECMAScript5 und erhielt vollen Support in nahezu allen verbreiteten Webbrowsern, abgesehen vom Internet Explorer.
Neue Features waren unter anderem \ac{JSON} Support und klassische Array Funktionen wie map und forEach.
...
Mittels Export lassen sich also Schnittstellen für ein Modul definieren, welche mit Hilfe des Keywords Import importiert und verwendet werden können.
