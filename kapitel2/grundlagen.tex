...
\vspace{0.3cm}
\lstinputlisting[language=Javascript,label=cordova-camera-example,caption=Cordova Kamera Beispiel]{kapitel2/cordova-plugin-example.js}
\vspace{0.3cm}
...
unter Verwendung des @ Symbols an Elemente einer Anwendung angebracht werden.
