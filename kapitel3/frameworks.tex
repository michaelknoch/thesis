...
\ac{NPM} ist der Package Manager von Node.js mit über 300.000 verschiedenen Paketen und
4.939.882.172 Paket Installationen im Juni 2016.
Open Source Pakete können kostenfrei veröffentlicht werden.
Für die Verwaltung von Closed Source Paketen wird ein Premium Preismodell ab einem Aufpreis von 7\$ pro Monat angeboten.
\ac{NPM} wird nicht ausschließlich für die Node Entwicklung verwendet, JavaScript Pakete wie Angular, Ionic, Electron und deren
Abhängigkeiten können ebenfalls komplett über \ac{NPM} geladen werden.

\section{Gulp}

Gulp ist ein Build System zur Optimierung und Automatisierung von Abläufen komplexer Softwareprodukte.
