...
\subsubsection{Ionic \ac{CLI}}
Das \textbf{Ionic \ac{CLI}} vereinfacht den Umgang mit Ionic Projekten. Zunächst können individuelle
...
\subsubsection{Ionic Creator}
\textbf{Ionic Creator} ist ein hauseigenes Prototyping Tool, mit welchem Oberflächen statt
...
\subsubsection{Ionic Lab}
\textbf{Ionic Lab} ist eine visuelle Oberfläche zur Bedienung des Ionic \ac{CLI}.
...
Veröffentlichung und Skalierung von Apps. Ionic Platform bietet beispiwlesweise einen zentralen Dienst für die Handhabung von Nutzern.
Nutzer können sich klassich per Mail oder per single sign on über
Facebook, Google und Twitter registrieren und damit in der App authentifizieren.
User können zentral in einer Weboberfläche verwaltet und ggfls. mit Push Nachrichten adressiert werden.
Diese können zentral an alle Nutzer, oder ein definiertes Segment der Nutzer gesendet werden.
...
Zusätzlich kann die Cloud für das Deployment von Apps automatisiert für diverse Zielplatformen genutzt werden.
Interessant hierbei ist, dass iOS Apps generiert werden könne, auch wenn einem Entwickler
