...
\newcommand{\zusammenfassung}{Als praktischen Teil der Arbeit soll eine Frontend Architektur für ein Monitoring System für verteilte Systeme konzipiert und implementiert werden um
mit nahezu einer Codebasis Endprodukte für Web, Desktop und Mobile zu erhalten.
Anhand der paktischen Arbeit sollen dabei Chancen und Risiken von Web Technologien hinsichtlich Cross Platform Entwicklungen aufgezeigt und evaluiert, so wie mögliche Einschränkungen
...
strukturieren lassen. Mithilfe der Frameworks Angular 2 und Ionic, welches ebenfalls auf Angular 2 aufbaut, sollen Plattformen für Web, so wie iOS und Android entwickelt werden.
Zusätzlich soll mittels Electron Framework eine Platform für native Desktop Applikation für MacOS, Linux und Windows geschaffen werden.}
